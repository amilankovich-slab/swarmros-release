## swarmros (kinetic) - 0.3.6-1

The packages in the `swarmros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic swarmros --edit` on `Wed, 01 Apr 2020 13:52:52 -0000`
...
## swarmros (kinetic) - 0.3.6-0

The packages in the `swarmros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic swarmros --edit` on `Thu, 12 Mar 2020 08:03:43 -0000`
